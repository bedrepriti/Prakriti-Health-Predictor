...
window.onload = function () {
  document.getElementById("print").addEventListener("click", () => {
      ...
      <div style="position: absolute; top: 10px; right: 10px; font-size: xx-small;">
          ...
          <div> made by <a href="https://prakriti-app-xvis.onrender.com/" target="_blank">PRAKRITI HELATH GUIDE</a> </div> 
      </div>
      ...
      <p>____________________________________________________________________________________________</p>
          ...
          <div id="subhead" style="text-align: center;font-size: small;">
              ...
              <div>Please note that Prakriti Health Predictor is not a substitute for professional medical advice.</div>
